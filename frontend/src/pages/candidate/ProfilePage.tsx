                ...
                <Table.Tbody>
                  {profile.employments.map((e, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={e.is_current ? 'saGreen' : 'gray'} variant="light" size="sm">
                          {e.is_current ? 'Yes' : 'No'}
                        </Badge>
                      </Table.Td>
                    </Table.Tr>
                ...
                <Table.Tbody>
                  {profile.qualifications.map((q, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={q.is_institution_registered ? 'saGreen' : 'saTerracotta'} variant="light" size="sm">
                ...
                <Table.Tbody>
                  {profile.criminal_records.map((r, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge
                          color={r.severity === 'major' ? 'saTerracotta' : r.severity === 'moderate' ? 'saGold' : 'saGreen'}
                          variant="light"
                          size="sm"
                        >
                          {r.severity}
                      ...
                      <Table.Td>
                        <Badge color={r.is_cleared ? 'saGreen' : 'saTerracotta'} variant="light" size="sm">
                          {r.is_cleared ? 'Yes' : 'No'}
                        </Badge>
                      </Table.Td>
                      <Table.Td>
                        {r.is_interpol_wanted ? (
                          <Badge color="saTerracotta" variant="filled" size="sm">
                ...
                <Table.Tbody>
                  {profile.credit_records.map((c, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={c.has_defaults ? 'saTerracotta' : 'saGreen'} variant="light" size="sm">
                          {c.has_defaults ? 'Yes' : 'No'}
                        </Badge>
                      </Table.Td>
                      <Table.Td>
                        <Badge color={c.has_judgements ? 'saTerracotta' : 'saGreen'} variant="light" size="sm">
                          {c.has_judgements ? 'Yes' : 'No'}
                        </Badge>
                      </Table.Td>
                      <Table.Td>
                        <Badge color={c.has_insolvency ? 'saTerracotta' : 'saGreen'} variant="light" size="sm">
                ...
                <Table.Tbody>
                  {profile.drivers_licences.map((l, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={l.is_valid ? 'saGreen' : 'saTerracotta'} variant="light" size="sm">
                ...
                <Table.Tbody>
                  {profile.professional_registrations.map((p, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={p.is_active ? 'saGreen' : 'saTerracotta'} variant="light" size="sm">
                          {p.is_active ? 'Active' : 'Inactive'}
                        </Badge>
                      </Table.Td>
                      <Table.Td>
                        <Badge color={p.is_in_good_standing ? 'saGreen' : 'saTerracotta'} variant="light" size="sm">
                ...
                <Table.Tbody>
                  {profile.addresses.map((a, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={a.is_current ? 'saGreen' : 'gray'} variant="light" size="sm">
                          {a.is_current ? 'Yes' : 'No'}
                        </Badge>
                      </Table.Td>
                    </Table.Tr>
                ...
                <Table.Tbody>
                  {profile.references.map((r, i) => (
                    <Table.Tr key={i}>
                      ...
                      <Table.Td>
                        <Badge color={r.is_verified ? 'saGreen' : 'gray'} variant="light" size="sm">
